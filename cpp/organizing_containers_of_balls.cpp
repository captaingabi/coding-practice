...
string organizingContainers(vector<vector<int>> container) {
    set<int> row_sums, col_sums;

    // Assuming both dimensions have the same size
    ...
    for(int i = 0; i < size; i++){
        ...
        row_sums.insert(row_sum);
        col_sums.insert(col_sum);
    }

    return row_sums == col_sums ? "Possible" : "Impossible";
}
