...
SinglyLinkedListNode* mergeLists(SinglyLinkedListNode* head1, SinglyLinkedListNode* head2) {
    SinglyLinkedListNode *result = NULL, *prev = NULL, *curr = NULL;
    while(!(head1 == NULL && head2 == NULL)){
        curr = malloc(sizeof(SinglyLinkedListNode));
        curr->next = NULL;
...
int main()
{
    ...
    if (tests_endptr == tests_str) { exit(EXIT_FAILURE); }
    ...
    for (int tests_itr = 0; tests_itr < tests; tests_itr++) {
        ...
        if (llist1_count_endptr == llist1_count_str) { exit(EXIT_FAILURE); }
        ...
        for (int i = 0; i < llist1_count; i++) {
            ...
            if (llist1_item_endptr == llist1_item_str) { exit(EXIT_FAILURE); }
        ...
        if (llist2_count_endptr == llist2_count_str) { exit(EXIT_FAILURE); }
        ...
        for (int i = 0; i < llist2_count; i++) {
            ...
            if (llist2_item_endptr == llist2_item_str) { exit(EXIT_FAILURE); }
